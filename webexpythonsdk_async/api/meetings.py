...
class MeetingsAPI:
    ...
    def __init__(self, session: AsyncRestSession, object_factory):
        """Init a new MeetingsAPI object with the provided AsyncRestSession.
    ...
    async def get(self, meetingId):
        ...
        # API request
        json_data = await self._session.get(request_url + "/" + meetingId)

        # Return a membership object created from the response JSON data
        return self._object_factory(OBJECT_TYPE, json_data)

    async def delete(self, meetingId):
        ...
        # API request
        await self._session.delete(request_url + "/" + meetingId)
    ...
    async def update(
        ...
        **request_parameters,
        ...
        # API request
        json_data = await self._session.put(request_url + "/" + meetingId, json=put_data)
